...
data = spark.read.csv("./Classification/fb_live_thailand.csv", header=True, inferSchema=True)
...
evaluator = MulticlassClassificationEvaluator(labelCol="status_type_ind", \
...
"""
โค้ดนี้สร้างโมเดลการจำแนกประเภทโพสต์บน Facebook โดยใช้การถดถอยเชิงโลจิสติก
ทำให้สามารถวิเคราะห์ข้อมูลได้อย่างมีประสิทธิภาพ
"""